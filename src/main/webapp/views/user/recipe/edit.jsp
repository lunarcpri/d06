...
<form:form action="user/recipe/edit.do?recipeId=${recipe.id}" modelAttribute="recipe" method="POST">
    ...
    <h2><spring:message code="quantities"/> </h2>
        ...
        <div class="block">
            <a href="${contextPath}/user/recipe/edit.do?recipeId=${recipe.id}&nIngredients=${nIngredients+1}&nSteps=${nSteps}" class="button">
    ...
    <div class="form-group-1">
       ...
       <h1>Steps</h1>
        ...
        <div class="block">
            <a href="${contextPath}/user/recipe/edit.do?recipeId=${recipeId}&nIngredients=${nIngredients}&nSteps=${nSteps+1}" class="button" id="add-quantity">

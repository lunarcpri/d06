...
<section class="main">
    <h1>Edit <spring:message code="recipe"/> ${recipe.title}</h1>

    <div class="form-group-2">
        <form:form action="user/recipe/edit.do?recipeId=${recipe.id}" modelAttribute="recipe" method="POST">
        <form:hidden path="id"/>
    ...
    <div class="form-group-2">
        ...
        <article id="quantities-list">
            <jstl:forEach begin="0" end="${nIngredients-1}" varStatus="index">
                <form:hidden path="quantities[${index.index}].version"/>
                <form:hidden path="steps[${index.index}].id"/>
                <div id="ingredient-quantity0">
                    ...
                    <div class="col s3">
                        ...
                        <form:input style="width:80px" step="any" path="quantities[${index.index}].quantity"
                                    type="number"/>
                    ...
                    <div class="col s3">
                        ...
                        <form:select path="quantities[${index.index}].unit" style="width:120px">
                            <jstl:forEach
                                    items="gram, kilograms, ounces, pounds, militres, litres, spoons, cups, pieces"
                                    var="unit">
        ...
        <div class="block">
            <a href="${contextPath}/user/recipe/edit.do?recipeId=${recipe.id}&nIngredients=${nIngredients+1}&nSteps=${nSteps}"
               class="button">
    ...
    <div class="form-group-1">
        ...
        <jstl:forEach begin="0" end="${nSteps-1}" varStatus="index">
            <form:hidden path="steps[${index.index}].version"/>
            <form:hidden path="steps[${index.index}].id"/>
        ...
        <div class="block">
            <a href="${contextPath}/user/recipe/edit.do?recipeId=${recipeId}&nIngredients=${nIngredients}&nSteps=${nSteps+1}"
               class="button" id="add-quantity">

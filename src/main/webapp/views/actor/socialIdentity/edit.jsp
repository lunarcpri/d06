    ...
    <div class="form-group-1 socialIdentity">
        ...
        <div class="card inline s10">
            ...
            <div class="block">
                ...
                <input name="save" type="submit" value="<spring:message code="send"/>"/>
                <a class="button"
                   href="${context}/actor/socialIdentity/delete.do?socialIdentityId=${socialIdentity.id}">

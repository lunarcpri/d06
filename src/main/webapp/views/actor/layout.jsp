...
<article class="col s3 navbar">
    <ul>
        ...
        <security:authorize access="hasAnyRole('NUTRITIONIST')">
            <li><a href="${contextPath}/nutritionist/curriculum/list.do"><spring:message code="managecurriculum"/></a>
            </li>
        </security:authorize>
        <security:authorize access="hasAnyRole('USER')">
            <li><a href="${contextPath}/user/recipe/list.do"><spring:message code="managerecipes"/> </a></li>
        </security:authorize>
        <li><a href="${contextPath}/actor/socialIdentity/list.do"><spring:message code="managesocialidentities"/> </a>
        </li>
    </ul>
</article>

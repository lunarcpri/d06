...
<section class="main">
    ...
    <article class="col s4">
        ...
        <p><b><spring:message code="category"/>:</b> <a
                href="/category/${recipe.category.id}.do}">${recipe.category.name}</a></p>
        ...
        <jstl:if test="${canlike==true}">
            <div class="likes">
                <a href="${likeURI}" class="like<jstl:if test="${liked==true}"> liked</jstl:if>"><i
                        class="fa fa-thumbs-up"></i></a>
                <a href="${dislikeURI}" class="dislike<jstl:if test="${disliked==true}"> disliked</jstl:if>"><i
